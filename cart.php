    ...
    <div class="row" style="margin-top:10px;">
      <div class="large-12">
        <?php
          ...
          echo '<td colspan="4" align="right"><a href="update-cart.php?action=empty" class="button alert">Empty Cart</a>&nbsp;<a href="products.php" class="button [primary warning]">Pick More?</a>';

          if(isset($_SESSION['username'])) {
            echo '<a href="payment.php"><button style="float:right;">Checkout</button></a>';
          }
